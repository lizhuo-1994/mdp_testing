...
def main():
    ...
    parser.add_argument("--method", help="test method", default='mdpfuzz', type=str)
    ...
    while current_time - start_fuzz_time < 3600 * args.hour and len(fuzzer.corpus) > 0:
        ...
        print(sequences[-1].tolist(), failure_flag, abstract_id, novelty_dict[abstract_id], len(set(fuzz_failure_ids)))
        information_list.append([sequences[-1].tolist(), failure_flag, abstract_id])
