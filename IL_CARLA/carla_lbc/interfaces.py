...
class Carla_ENV:
    ...
    def from_test_case(self, test_case):
        self.start_pose_x = test_case[0]
        self.start_pose_y = test_case[1]
        self.start_pose_yaw = test_case[2]
        self.vehicles = []
        for i in range(100):
            v_x = test_case[3 + i * 2]
            v_y = test_case[4 + i * 2] 
            self.vehicles.append((v_x, v_y))
        self.target_pose_x = test_case[-3]
        self.target_pose_y = test_case[-2]
        self.weather = int(test_case[-1])
